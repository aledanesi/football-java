...
public class PlayerAction extends FileUploadAction implements
		ServletRequestAware, ModelDriven<Player> {
	...
	public PlayerAction() {
		...
		positionManager = (PositionManager) SpringHelper
	 ...
	 * @return String
	 */
	@Action(value = "/insertPlayer", results = { @Result(name = "editPlayer", location = "/content/editPlayer.jsp") })
	public String insert() {
		...
		if (!StringUtils.isEmpty(request.getParameter("teamId"))) {
			request.setAttribute("teamId", Long.parseLong(request
					.getParameter("teamId")));
		}
		if (!StringUtils.isEmpty(request.getParameter("divisionId"))) {
			request.setAttribute("divisionId", Long.parseLong(request
	 ...
	 * @return String
	 */
	@Action(value = "/editPlayer", results = { @Result(name = "editPlayer", location = "/content/editPlayer.jsp") })
	public String edit() {
		HttpServletRequest request = (HttpServletRequest) ActionContext
				.getContext().get(ServletActionContext.HTTP_REQUEST);
	...
	public String save() {
		Position position = positionManager.getPositionById(player
				.getPosition().getId());
		...
		if (userImage != null) {
			...
			player.setImage(playerManager.getPlayerById(player.getId())
					.getImage());
		}
	 ...
	 * @return String
	 */
	@Action(value = "/viewPlayer", results = { @Result(name = "viewPlayer", location = "/content/viewPlayer.jsp") })
	public String view() {
		HttpServletRequest request = (HttpServletRequest) ActionContext
				.getContext().get(ServletActionContext.HTTP_REQUEST);
	 ...
	 * @return String
	 */
	@Action(value = "/listByTeamPlayer", results = { @Result(name = "success", location = "/content/listPlayer.jsp") })
	 ...
	 * @return String
	 */
	@Action(value = "/listPlayer", results = { @Result(name = "success", location = "/content/listPlayer.jsp") })
	public String list() {
	 ...
	 * @return String
	 */
	@Action(value = "/deletePlayer", results = { @Result(name = "success", location = "/content/listPlayer.jsp") })
	 ...
	 * @return String
	 */
	@Action(value = "/searchPlayer", results = { @Result(name = "searchPlayer", location = "/content/searchPlayer.jsp") })
