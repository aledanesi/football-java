...
public class TeamAction extends FileUploadAction implements ServletRequestAware, ModelDriven<Team>
{
	 ...
	 * @return String
	 */
	@Action( value   = "/insertTeam",
			 results = { @Result(name  = "editTeam", location = "/content/editTeam.jsp") }
	) 	
	 ...
	 * @return String
	 */
	@Action( value   = "/saveOrUpdateTeam",
			 results = { @Result(name  = "success", location = "/content/listTeam.jsp"),
	 ...
	 * @return String
	 */
	@Action( value   = "/changeTeam",
			 results = { @Result(name  = "changeTeam", location = "/content/changeTeam.jsp") }
	) 	
	public String change()
	{
		...
		nationList = nationManager.listNations();
		teamList = teamManager.listTeamsByDivision(team.getDivision().getId());
