...
public class Career implements Serializable
{
	...
	@Column(name = "MONTH_TRANSFER")
	private String monthTransfer;
	...
	public String getMonthTransfer()
	{
		return monthTransfer;
	}

	public void setMonthTransfer(String monthTransfer)
	{
	...
	public String toString()
	{
		...
		sb.append(", partiteGiocate: " + dettaglioCarriera.getPartiteGiocate());
		sb.append(", goal: " + goal);
		sb.append("]");
		return sb.toString();
	}
