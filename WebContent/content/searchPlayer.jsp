...
<div id="page">
  ...
  <tr>
    ...
    <s:iterator value="lettereRicerca" status="obj">
      <td><a href="searchPlayer.actioniniziale=<s:property />"><s:property /></a></td>
    </s:iterator>
  ...
  <tr>
      <td>
              ...
              <input type='button' name='iniziale' value='Reset' size='28' onclick="javascript: document.location.href='searchPlayer.actioniniziale=';" />
      </td>
  </tr>
