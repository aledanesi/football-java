...
<head> 
  ...
  <script type="text/javascript">
    ...
    function changeSelect()
    {
      ...
      var str = "handleSeason.action?";
      if (seasonId != null)
      {
    	  str += "seasonYear.id=" + seasonId + "&"; 
      }
      if (divisionId != null)
      {
    	  str += "division.id=" + divisionId + "&";
      }
      if (nationId != null)
      {
    	  str += "nation.id=" + nationId + "&";
      }      
  ...
  <div align="center">   
      <s:form action="saveSeason" style="width: 200px">
        <s:push value="season">
          ...
          <s:select name="nation.id" id="nationId" list="nationList" listKey="id" listValue="name" onchange="changeSelect()"  />
